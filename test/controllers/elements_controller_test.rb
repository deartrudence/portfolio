...
class ElementsControllerTest < ActionController::TestCase
  ...
  test "should create element" do
    assert_difference('Element.count') do
      post :create, element: { html_subtag: @element.html_subtag, html_tag: @element.html_tag, name: @element.name, order: @element.order, url: @element.url }
    end
  ...
  test "should update element" do
    patch :update, id: @element, element: { html_subtag: @element.html_subtag, html_tag: @element.html_tag, name: @element.name, order: @element.order, url: @element.url }
    assert_redirected_to element_path(assigns(:element))
  end
